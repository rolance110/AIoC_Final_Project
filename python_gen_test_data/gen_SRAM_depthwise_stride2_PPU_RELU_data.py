...
SCALING_FACTOR = 2     # 右移位數
RELU_ENABLE    = True  # 啟用 ReLU
...
# ─── 存檔：SRAM ───
with open('../sim/depthwise_stride2_ppu_relu_memory.hex','w') as f:
...
# # ─── 存檔：RAW golden ───
# with open('../sim/depthwise_stride2_golden_raw.hex','w') as f:
...
# ─── 存檔：PPU golden ───
with open('../sim/depthwise_stride2_ppu_relu_golden.hex','w') as f:
...
# ─── Log ───
print("✅ SRAM → depthwise_stride2_ppu_relu_memory.hex")
# print("✅ RAW  → depthwise_stride2_golden_raw.hex")
print("✅ PPU  → depthwise_stride2_ppu_relu_golden.hex")

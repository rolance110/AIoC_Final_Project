...
RELU_ENABLE     = True  # True→啟用 ReLU；False→不啟用
...
# ========= 存檔：SRAM 影像 =========
with open('../sim/pointwise_ppu_relu_memory.hex', 'w') as f:
...
# ========= 存檔：經過 PPU 的 golden =========
with open('../sim/pointwise_ppu_relu_golden.hex', 'w') as f:
...
# ========= 報告 =========
print("✅ SRAM 初始化完成 → ../sim/pointwise_ppu_relu_memory.hex")
# print("✅ RAW Golden (無 PPU)  → ../sim/pointwise_golden.hex")
print("✅ PPU Golden          → ../sim/pointwise_ppu_relu_golden.hex")

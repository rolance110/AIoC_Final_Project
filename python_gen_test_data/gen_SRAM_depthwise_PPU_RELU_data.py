...
# ❹-1 SRAM 影像
with open('../sim/depthwise_ppu_relu_memory.hex', 'w') as f:
...
with open('../sim/depthwise_ppu_relu_golden.hex', 'w') as f:
...
# ========== ❺ Log ==========
print("✅ SRAM → ../sim/depthwise_ppu_relu_memory.hex")
# print("✅ RAW  → ../sim/depthwise_golden_raw.hex")
print("✅ PPU  → ../sim/depthwise_ppu_relu_golden.hex")

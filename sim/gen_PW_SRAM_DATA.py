...
print("Weight, Ifmap, Ipsum, and Opsum initialized successfully.")
print(f"Weight shape: {weight.shape}, Ifmap shape: {ifmap.shape}, Ipsum shape: {ipsum.shape}, Opsum shape: {golden_opsum.shape}")
print(f"Total SRAM size: {total_sram_size} bytes, used: {total_sram_size} bytes")
print(f"Weight base address: {weight_base:#010X}, Ifmap base address: {ifmap_base:#010X}, Ipsum base address: {ipsum_base:#010X}, Opsum base address: {opsum_base:#010X}")
